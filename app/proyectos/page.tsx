...
const ProjectLogos = [
  { name: 'Ciudad El Doral', logo: '/images/muro/home/CIUDAD-EL-DORAL.jpg' },
  { name: 'Residencial Monte Nebo', logo: '/images/muro/home/MONTE-NEBO.jpg' },
  { name: 'Praderas del Mombacho', logo: '/images/muro/home/MOMBACHO.jpg' },
  { name: 'Ciudad Campuzano', logo: '/images/muro/home/CAMPUZANO.jpg' },
  { name: 'Programa Bismarck Martinez', logo: '/images/muro/home/BISMARCK-MARTINEZ.jpg' },
  { name: 'INVUR', logo: '/images/muro/home/INVUR.jpg' }
];
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-24 bg-white border-b border-gray-100">
        <div className="container mx-auto px-6 md:px-12 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 items-center justify-items-center transition-all duration-500">
            {ProjectLogos.map((logo, idx) => (
              <div key={idx} className="flex flex-col items-center justify-center p-4 text-center">
                <div className="w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center mb-4 border-2 border-transparent hover:border-[#96C121] transition-all overflow-hidden relative">
                  {logo.logo ? (
                    <Image src={logo.logo} alt={`Logo de ${logo.name}`} fill className="object-contain p-2" />
                  ) : (
